...
export const slaPorra = {
    probablyWords: [
        "banana", "roblox", "ingles",
        "maca", "minecraft" , "doacao"
    ],
    matched: 1,
}
...
function showAnswer(index) {
    switch (index) {
        ...
        case 5:
            return "Vai se foder porra"
        default:
            return "Só sei falar de futebol meu amigo, se não for isso, vai tomar no cu!"
    }
}

export function mostProbablyQuestion(pergunta) {
    if (pergunta.includes("tenis")) {
        return "não falo de tenis"
    }
    let matches = [
